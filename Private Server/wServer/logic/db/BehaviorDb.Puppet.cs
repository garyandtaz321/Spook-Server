    ...
    partial class BehaviorDb
    {
        ...
        .Init("Healer Puppet",
                new State(
                    ...
                    new Heal(10, "Healers", coolDown: 3000)
                    ),
                new ItemLoot("Magic Potion", 0.1),
                new Threshold(0.1,
                    new ItemLoot("Golden Bow", 0.02),
        ...
        .Init("The Puppet Master",
         ...
         .Init("Puppet Master v2",
                    ...
                    new State("init",
                new Taunt(1.00, "Welcome back heros!. you thought my story was over, no, not even close!"),
                        new Taunt(1.00, "Behold!")
                        // Spawn little cancer puppets
                    ),
                    new State("normal fire",
                        new Taunt(1.00, "Behold!")
                        // Fire the stupid little Daze balls
                        // Fire the stupid (OP) pet statis
                        // Fire the poop blue shots
                        // New Order Huntress puppet to active stage YEET
                        ),
                    new State("huntress puppet",
                        new Taunt(1.00, "Awaken my dear puppet, hunt them down!")
                        // Huntress puppet BS
                        // Puppet man will run check for huntress

                        ),
                                        new State("trickster puppet",
                        new Taunt(1.00, "Awaken my dear puppet, fear it's blades!")
                        // Huntress puppet BS
                        //puppet

                        ),
                                                            new State("OP puppets",
                        new Taunt(1.00, "Awaken puppets, avenge your fallen brethens")
                        // Huntress puppet BS
